CLASS LHC_/EXAOTP/I_TPADHOCALG_S DEFINITION FINAL INHERITING FROM CL_ABAP_BEHAVIOR_HANDLER.
  PRIVATE SECTION.
    METHODS:
      AUGMENT FOR MODIFY
        IMPORTING
          ENTITIES_CREATE FOR CREATE TpAdhocAlgAll\_TpAdhocAlg
          ENTITIES_UPDATE FOR UPDATE TpAdhocAlg.
ENDCLASS.

CLASS LHC_/EXAOTP/I_TPADHOCALG_S IMPLEMENTATION.
  METHOD AUGMENT.
    DATA: text_for_new_entity      TYPE TABLE FOR CREATE /EXAOTP/I_TpAdhocAlg\_TpAdhocAlgText,
          text_for_existing_entity TYPE TABLE FOR CREATE /EXAOTP/I_TpAdhocAlg\_TpAdhocAlgText,
          text_update              TYPE TABLE FOR UPDATE /EXAOTP/I_TpAdhocAlgText.
    ...
    DATA: text_tky_link  TYPE STRUCTURE FOR READ LINK /EXAOTP/I_TpAdhocAlg\_TpAdhocAlgText,
    ...
    ENDLOOP.
    MODIFY AUGMENTING ENTITIES OF /EXAOTP/I_TpAdhocAlg_S
      ENTITY TpAdhocAlg
        CREATE BY \_TpAdhocAlgText
        FROM text_for_new_entity
        RELATING TO entities_create BY relates_create.

    IF entities_update IS NOT INITIAL.
      READ ENTITIES OF /EXAOTP/I_TpAdhocAlg_S

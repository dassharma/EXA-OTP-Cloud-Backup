class /EXAOTP/CL_TPADHOC_SHMA_AREA definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value '/EXAOTP/CL_TPADHOC_SHMA_AREA' ##NO_TEXT.
  data ROOT type ref to /EXAOTP/CL_TPADHOC_SHMA read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to /EXAOTP/CL_TPADHOC_SHMA_AREA
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to /EXAOTP/CL_TPADHOC_SHMA
    raising
...
CLASS /EXAOTP/CL_TPADHOC_SHMA_AREA IMPLEMENTATION.
